...
class Calculator extends React.Component {
    ...
    render() {
        ...
        return (
            <div>
                <TemperatureHandler scale={scale.Celsius} onTemperatureChange={this.handleCelsiusChange} temperature={temperatureCelsius}/>
                <TemperatureHandler scale={scale.Farenheit} onTemperatureChange={this.handleFarenheitChange} temperature={temperatureFarenheit}/>
